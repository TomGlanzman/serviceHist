...
INSERT INTO DESC_ORG_AUTHORITIES (AUTHID,AUTHNAME) VALUES (2,'DESC Spokesperson/Mgmt. Team');
...
INSERT INTO DESC_ORG_ROLES (ROLEID,ROLENAME) VALUES (20,'Spokesperson elect');
INSERT INTO DESC_ORG_ROLES (ROLEID,ROLENAME) VALUES (21,'Non-voting member');
...
INSERT INTO DESC_ORG_GROUPS (GROUPID,GROUPNAME,GROUPABBRV,AUTHID,GROUPSTART,GROUPEND,NOTES) VALUES (12,'Spokesperson Nominating Committee','SNC',8,'','','created every two years (replaced by SSC Sep 2024)'); 
...
INSERT INTO DESC_ORG_GROUPS (GROUPID,GROUPNAME,GROUPABBRV,AUTHID,GROUPSTART,GROUPEND,NOTES) VALUES (54,'Spokesperson Sustainability Committee','SPSC',8,'2023-12-21','2024-09-09','ad hoc committee');
INSERT INTO DESC_ORG_GROUPS (GROUPID,GROUPNAME,GROUPABBRV,AUTHID,GROUPSTART,GROUPEND,NOTES) VALUES (55,'Spokesperson Succession Committee','SSC',8,'2024-09-09','','');
INSERT INTO DESC_ORG_GROUPS (GROUPID,GROUPNAME,GROUPABBRV,AUTHID,GROUPSTART,GROUPEND,NOTES) VALUES (56,'Paper Review Committee','PRC',8,'2025-10-08','','');
...
INSERT INTO DESC_ORG_GROUPS (GROUPID,GROUPNAME,GROUPABBRV,AUTHID,GROUPSTART,GROUPEND,NOTES) VALUES (104,'Sensor Anomalies Working Group','SAWG',3,'2015-02-01','2024-04-30','Paused thru commissioning'); 

INSERT INTO DESC_ORG_GROUPS (GROUPID,GROUPNAME,GROUPABBRV,AUTHID,GROUPSTART,GROUPEND,NOTES) VALUES (105,'Computing Working Group','CO',4,'2019-09-01','2026-01-30','Formed from CI and CSS WGs');
INSERT INTO DESC_ORG_GROUPS (GROUPID,GROUPNAME,GROUPABBRV,AUTHID,GROUPSTART,GROUPEND,NOTES) VALUES (106,'Cosmological and Survey Sims Working Group','CSS',4,'2021-01-03','2026-01-30','');
INSERT INTO DESC_ORG_GROUPS (GROUPID,GROUPNAME,GROUPABBRV,AUTHID,GROUPSTART,GROUPEND,NOTES) VALUES (107,'Science Release and Validation Working Group','SRV',4,'2021-07-01','2026-01-30','');
INSERT INTO DESC_ORG_GROUPS (GROUPID,GROUPNAME,GROUPABBRV,AUTHID,GROUPSTART,GROUPEND,NOTES) VALUES (138,'Survey Computing and Simulation Working Group','SCS',4,'2026-01-30','','Formed from CO,CSS,SRV');
...
--INSERT INTO DESC_ORG_GROUPS (GROUPID,GROUPNAME,GROUPABBRV,AUTHID,GROUPSTART,GROUPEND,NOTES) VALUES (139,' Working Group','',,'','',''); 


/* The Topical Teams 200-299 */
/* Topical Teams are unique in that all have one or more "host" or sponsoring groups */
...
INSERT INTO DESC_ORG_GROUPS (GROUPID,GROUPNAME,GROUPABBRV,AUTHID,HOSTGRPID,GROUPSTART,GROUPEND,NOTES) VALUES (212,'Redshift Assessment Infrastructure Layers Topical Team','RAIL',2,110,'2021-08-20','2026-01-30','within PZ');
...
INSERT INTO DESC_ORG_GROUPS (GROUPID,GROUPNAME,GROUPABBRV,AUTHID,HOSTGRPID,GROUPSTART,GROUPEND,NOTES) VALUES (220,'Lyman Break Galaxies Topical Team','',2,136,'2024-06-18','','within WLSS');
INSERT INTO DESC_ORG_GROUPS (GROUPID,GROUPNAME,GROUPABBRV,AUTHID,HOSTGRPID,GROUPSTART,GROUPEND,NOTES) VALUES (221,'Standard Sirens Topical Team','',2,132,'2025-05-20','','within MCP');
INSERT INTO DESC_ORG_GROUPS (GROUPID,GROUPNAME,GROUPABBRV,AUTHID,HOSTGRPID,GROUPSTART,GROUPEND,NOTES) VALUES (222,'Stellar Streams Topical Team','',2,108,'2025-06-23','','within DM');
INSERT INTO DESC_ORG_GROUPS (GROUPID,GROUPNAME,GROUPABBRV,AUTHID,HOSTGRPID,GROUPSTART,GROUPEND,NOTES) VALUES (223,'Static Analysis Roundtable Topical Team','STAR',2,136,'2025-10-31','','within WLSS, MCP, CL');
INSERT INTO DESC_ORG_GROUPS (GROUPID,GROUPNAME,GROUPABBRV,AUTHID,HOSTGRPID,GROUPSTART,GROUPEND,NOTES) VALUES (224,'PZ Challenge and RAIL Development Topical Team','RAIL',2,110,'2026-02-01','','within PZ');
...
INSERT INTO DESC_ORG_GROUPS (GROUPID,GROUPNAME,GROUPABBRV,AUTHID,GROUPSTART,GROUPEND,NOTES) VALUES (323,'Early Science Task Force','ES',2,'2024-07-03','','');

INSERT INTO DESC_ORG_GROUPS (GROUPID,GROUPNAME,GROUPABBRV,AUTHID,GROUPSTART,GROUPEND,NOTES) VALUES (324,'Artificial Intelligence for DESC Task Force','AID',6,'2025-10-03','','');
